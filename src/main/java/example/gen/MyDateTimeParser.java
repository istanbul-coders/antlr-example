...
public class MyDateTimeParser extends Parser {
	...
	@Override
	public String getGrammarFileName() { return "MyDateTime.g4"; }
	...
	public MyDateTimeParser(TokenStream input) {
		super(input);
	...
	public static class Date_timeContext extends ParserRuleContext {
		...
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).enterDate_time(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).exitDate_time(this);
		}
	}
	...
	public static class DayContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).enterDay(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).exitDay(this);
		}
	}
	...
	public static class DateContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).enterDate(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).exitDate(this);
		}
	}
	...
	public static class MonthContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).enterMonth(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).exitMonth(this);
		}
	}
	...
	public static class TimeContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).enterTime(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).exitTime(this);
		}
	}
	...
	public static class HourContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).enterHour(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).exitHour(this);
		}
	}
	...
	public static class ZoneContext extends ParserRuleContext {
		public TerminalNode ALPHA() { return getToken(MyDateTimeParser.ALPHA, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).enterZone(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).exitZone(this);
		}
	}
	...
	public static class Two_digitContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).enterTwo_digit(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).exitTwo_digit(this);
		}
	}
	...
	public static class Four_digitContext extends ParserRuleContext {
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).enterFour_digit(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).exitFour_digit(this);
		}
	}
	...
	public static class AlphanumericContext extends ParserRuleContext {
		public TerminalNode ALPHA() { return getToken(MyDateTimeParser.ALPHA, 0); }
		public TerminalNode DIGIT() { return getToken(MyDateTimeParser.DIGIT, 0); }
		...
		@Override
		public void enterRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).enterAlphanumeric(this);
		}
		@Override
		public void exitRule(ParseTreeListener listener) {
			if ( listener instanceof MyDateTimeListener ) ((MyDateTimeListener)listener).exitAlphanumeric(this);
		}
	}
